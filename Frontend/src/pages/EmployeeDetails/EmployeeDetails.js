  ...
  return (
    <div className="employee-details-container">
      <div className="details-left">
        <h1>{employee?.name}</h1>
        <h4 className="head-indicator">
          {employee?.head.status ? "Head of Department" : null}
        </h4>
        ...
        <h4 onClick={() => setState(employee?.department.name)}>
          Department :
      ...
      <div
        className={
          employee?.head.status ? "employee-right-head" : "employee-right"
        }
      >
